...
// ************ THESE ARE THE BD3 UPDATES
// specialization for 3D
template<>
struct YeeUpdateD<ThreeD, BD3>{
	double dt, dx;

	YeeUpdateD<ThreeD, BD3>(double deltat, double deltax): dt(deltat), dx(deltax) {};
	...
	void operator()(YeeCell & f){
		...
		f.Dx() = 21.0/23.0*f.Dx() 
				+3.0/23.0*f.BD(0).Dx()
				-1.0/23.0*f.BD(1).Dx()
				+24.0/23.0*dt/dx*(1.0/f.pmlEKy()*fdtd::DifferenceOperator<fdtd::Hz, Dir::Y>::get(f) - 1.0/f.pmlEKz()*fdtd::DifferenceOperator<fdtd::Hy, Dir::Z>::get(f));

		double hDy = f.Dy();
		f.Dy() = 21.0/23.0*f.Dy() 
				+3.0/23.0*f.BD(0).Dy()
				-1.0/23.0*f.BD(1).Dy()
				+24.0/23.0*dt/dx*(1.0/f.pmlEKz()*fdtd::DifferenceOperator<fdtd::Hx, Dir::Z>::get(f) - 1.0/f.pmlEKx()*fdtd::DifferenceOperator<fdtd::Hz, Dir::X>::get(f));
		
		double hDz = f.Dz();
		f.Dz() = 21.0/23.0*f.Dz() 
				+3.0/23.0*f.BD(0).Dz()
				-1.0/23.0*f.BD(1).Dz()
				+24.0/23.0*dt/dx*(1.0/f.pmlEKx()*fdtd::DifferenceOperator<fdtd::Hy, Dir::X>::get(f) - 1.0/f.pmlEKy()*fdtd::DifferenceOperator<fdtd::Hx, Dir::Y>::get(f));
...
// specialization for TE
template<>
struct YeeUpdateD<TE, BD3>{
	double dt, dx;

	YeeUpdateD<TE, BD3>(double deltat, double deltax): dt(deltat), dx(deltax) {};
	...
	void operator()(YeeCell & f){
		...
		f.Dx() = 21.0/23.0*f.Dx() 
				+3.0/23.0*f.BD(0).Dx()
				-1.0/23.0*f.BD(1).Dx()
				+24.0/23.0*dt/dx*(1.0/f.pmlEKy()*fdtd::DifferenceOperator<fdtd::Hz, Dir::Y>::get(f));

		double hDy = f.Dy();
		f.Dy() = 21.0/23.0*f.Dy() 
				+3.0/23.0*f.BD(0).Dy()
				-1.0/23.0*f.BD(1).Dy()
				+24.0/23.0*dt/dx*(-1.0/f.pmlEKx()*fdtd::DifferenceOperator<fdtd::Hz, Dir::X>::get(f));
...
// specialization for TM
template<>
struct YeeUpdateD<TM, BD3>{
	double dt, dx;

	YeeUpdateD<TM, BD3>(double deltat, double deltax): dt(deltat), dx(deltax) {};
...
// specialization for TEM
template<>
struct YeeUpdateD<TEM, BD3>{
	double dt, dx;

	YeeUpdateD<TEM, BD3>(double deltat, double deltax): dt(deltat), dx(deltax) {};
	...
	void operator()(YeeCell & f){
		...
		f.Dz() = 21.0/23.0*f.Dz() 
				+3.0/23.0*f.BD(0).Dz()
				-1.0/23.0*f.BD(1).Dz()
				+24.0/23.0*dt/dx*(1.0/f.pmlEKx()*fdtd::DifferenceOperator<fdtd::Hy, Dir::X>::get(f));
...
// specialization for 3D
template<>
struct YeeUpdateB<ThreeD, BD3>{
	double dt, dx;

	YeeUpdateB<ThreeD, BD3>(double deltat, double deltax): dt(deltat), dx(deltax) {};
	...
	void operator()(YeeCell & f){
		...
		f.Bx() = 21.0/23.0*f.Bx() 
				+3.0/23.0*f.BD(0).Bx()
				-1.0/23.0*f.BD(1).Bx()
				-24.0/23.0*dt/dx*(1.0/f.pmlHKy()*fdtd::DifferenceOperator<fdtd::Ez, Dir::Y>::get(f) - 1.0/f.pmlHKz()*fdtd::DifferenceOperator<fdtd::Ey, Dir::Z>::get(f));
		
		auto hBy = f.By();
		f.By() = 21.0/23.0*f.By() 
				+3.0/23.0*f.BD(0).By()
				-1.0/23.0*f.BD(1).By()
				-24.0/23.0*dt/dx*(1.0/f.pmlHKz()*fdtd::DifferenceOperator<fdtd::Ex, Dir::Z>::get(f) - 1.0/f.pmlHKx()*fdtd::DifferenceOperator<fdtd::Ez, Dir::X>::get(f));
		
		auto hBz = f.Bz();
		f.Bz() = 21.0/23.0*f.Bz() 
				+3.0/23.0*f.BD(0).Bz()
				-1.0/23.0*f.BD(1).Bz()
				-24.0/23.0*dt/dx*(1.0/f.pmlHKx()*fdtd::DifferenceOperator<fdtd::Ey, Dir::X>::get(f) - 1.0/f.pmlHKy()*fdtd::DifferenceOperator<fdtd::Ex, Dir::Y>::get(f));
...
// specialization for TE
template<>
struct YeeUpdateB<TE, BD3>{
	double dt, dx;

	YeeUpdateB<TE, BD3>(double deltat, double deltax): dt(deltat), dx(deltax) {};
...
// specialization for TM
template<>
struct YeeUpdateB<TM, BD3>{
	double dt, dx;

	YeeUpdateB<TM, BD3>(double deltat, double deltax): dt(deltat), dx(deltax) {};
	...
	void operator()(YeeCell & f){
		...
		f.Bx() = 21.0/23.0*f.Bx() 
				+3.0/23.0*f.BD(0).Bx()
				-1.0/23.0*f.BD(1).Bx()
				-24.0/23.0*dt/dx*(1.0/f.pmlHKy()*fdtd::DifferenceOperator<fdtd::Ez, Dir::Y>::get(f));
		
		auto hBy = f.By();
		f.By() = 21.0/23.0*f.By() 
				+3.0/23.0*f.BD(0).By()
				-1.0/23.0*f.BD(1).By()
				-24.0/23.0*dt/dx*(-1.0/f.pmlHKx()*fdtd::DifferenceOperator<fdtd::Ez, Dir::X>::get(f));
...
// specialization for TEM
template<>
struct YeeUpdateB<TEM, BD3>{
	double dt, dx;

	YeeUpdateB<TEM, BD3>(double deltat, double deltax): dt(deltat), dx(deltax) {};
